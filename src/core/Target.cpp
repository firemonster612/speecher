...
QList<AppRecognitionRule> builtInAppRecognitionRules()
{
    return {
        ...
        {QStringLiteral("wezterm"), AppCategory::Terminal, WritingProfile::Work},
        {QStringLiteral("foot"), AppCategory::Terminal, WritingProfile::Work},
        {QStringLiteral("rio"), AppCategory::Terminal, WritingProfile::Work},
        {QStringLiteral("xterm"), AppCategory::Terminal, WritingProfile::Work},
        {QStringLiteral("urxvt"), AppCategory::Terminal, WritingProfile::Work},
        ...
        {QStringLiteral("chrome"), AppCategory::Browser, std::nullopt},
        {QStringLiteral("chromium"), AppCategory::Browser, std::nullopt},
