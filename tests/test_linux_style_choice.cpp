...
private slots:
    ...
    void choosesHostStyle_data()
    {
        ...
        QTest::newRow("override")
            ...
            << QStringLiteral("Windows") << QStringLiteral("Windows") << QStringLiteral("Breeze");
        QTest::newRow("Speecher light overrides Adwaita override")
            ...
            << QStringLiteral("Adwaita-Dark") << QStringLiteral("Adwaita") << QStringLiteral("Fusion");
        QTest::newRow("unavailable override")
            ...
            << QStringLiteral("system") << false
            << QStringLiteral("Oxygen") << QStringLiteral("Breeze") << QStringLiteral("Breeze");
        QTest::newRow("unavailable override keeps current non-GTK style")
            ...
            << QStringLiteral("system") << false
            << QStringLiteral("Oxygen") << QStringLiteral("kvantum") << QStringLiteral("kvantum");
        QTest::newRow("unavailable fallback keeps current style")
            << QStringLiteral("Oxygen") << QString() << QStringLiteral("KDE")
            << QStringLiteral("kde") << QStringLiteral("Windows")
            << QStringList{QStringLiteral("Fusion"), QStringLiteral("Windows")}
            << QStringLiteral("system") << false
            << QStringLiteral("Oxygen") << QStringLiteral("Windows") << QStringLiteral("Windows");
        QTest::newRow("KDE widget style")
            ...
            << QStringLiteral("system") << false
            << QStringLiteral("kvantum") << QStringLiteral("kvantum") << QStringLiteral("Breeze");
        ...
        QTest::newRow("KDE without widget style")
            ...
            << QStringList{QStringLiteral("Breeze"), QStringLiteral("Fusion")}
            << QStringLiteral("system") << false
            << QString() << QStringLiteral("Breeze") << QStringLiteral("Breeze");
        QTest::newRow("GNOME system dark")
            ...
            << QStringLiteral("adwaita-dark") << QStringLiteral("Adwaita-Dark") << QStringLiteral("Fusion");
        QTest::newRow("GNOME portal platform theme")
            << QString() << QString() << QStringLiteral("ubuntu:GNOME")
            << QStringLiteral("xdgdesktopportal") << QStringLiteral("Fusion")
            << QStringList{QStringLiteral("Adwaita"), QStringLiteral("Adwaita-Dark"), QStringLiteral("Fusion")}
            << QStringLiteral("system") << false
            << QStringLiteral("adwaita") << QStringLiteral("Adwaita") << QStringLiteral("Fusion");
        ...
        QTest::newRow("GNOME without Adwaita")
            ...
            << QStringLiteral("system") << false
            << QStringLiteral("adwaita") << QStringLiteral("Fusion") << QStringLiteral("Fusion");
        QTest::newRow("unknown desktop keeps current style")
            << QString() << QString() << QStringLiteral("sway")
            << QString() << QStringLiteral("Windows")
            << QStringList{QStringLiteral("Fusion"), QStringLiteral("Windows")}
            << QStringLiteral("system") << true
            << QString() << QStringLiteral("Windows") << QStringLiteral("Windows");
        QTest::newRow("non-KDE desktop keeps current Kvantum style")
            << QString() << QString() << QStringLiteral("LXQt")
            << QStringLiteral("lxqt") << QStringLiteral("kvantum")
            << QStringList{QStringLiteral("Fusion"), QStringLiteral("kvantum")}
            << QStringLiteral("system") << false
            << QString() << QStringLiteral("kvantum") << QStringLiteral("kvantum");
    ...
    void choosesHostStyle()
    {
        ...
        QCOMPARE(choice.fallback, fallback);
    }
};
